...
DY_PROCESSING_TABLENAME: DY-MLO-NotifProcessingLog-DEV
   ...
   try:
      ...
      if db_status in [DBStatus.succeeded, DBStatus.failed]:
        ...
        error_code = failure_reason
         ...
         total_time_spent_so_far = mlo_manager.get_time_duration(status_init_time)
         if total_time_spent_so_far > body['info']['avg_wait_time']*1000: #time in body in secs.
